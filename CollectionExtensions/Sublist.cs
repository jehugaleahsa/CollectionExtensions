...
namespace CollectionExtensions
{
    ...
    public static class Sublist
    {
        ...
        /// </exception>
        /// <exception cref="System.FormatException">A value is not in a format recognized by the format provider.</exception>
        /// <exception cref="System.OverflowException">A value represents a number that is out of the range of TDest.</exception>
        public static void AddConverted<TSourceList, T, TDestinationList, TDestination>(
            IReadOnlySublist<TSourceList, T> source,
            IExpandableSublist<TDestinationList, TDestination> destination)
            where TSourceList : IList<T>
            where TDestinationList : IList<TDestination>
        {
            ...
            addConverted<TSourceList, T, TDestinationList, TDestination>(source, destination, convert<T, TDestination>);
        }
        ...
        private static TDestination convert<T, TDestination>(T value)
        {
            return Converter<TDestination>.Convert(value, CultureInfo.CurrentCulture);
        }
            ...
            where TDestinationList : IList<TDestination>
        {
            ...
            return copyConverted<TSourceList, T, TDestinationList, TDestination>(source, destination, convert<T, TDestination>);
        }
