...
namespace CollectionExtensions.Test
{
    ...
    public class CopyConvertedTester
    {
        ...
        public void TestCopyConverted_BetweenStringAndDouble()
        {
            ...
            Sublist.CopyConverted(numbers.ToSublist(), strings.ToSublist());

            // convert back to a list of doubles
            var converted = new List<double>(100);
            Sublist.Grow(converted, 100, 0d);
            Sublist.CopyConverted(strings.ToSublist(), converted.ToSublist());
        ...
        public void TestCopyConverted_DefaultConverter_NullList_Throws()
        {
            Sublist<List<int>, int> list = null;
            Sublist<List<int>, int> destination = new List<int>();
            Sublist.CopyConverted(list, destination);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void TestCopyConverted_DefaultConverter_NullDestination_Throws()
        {
